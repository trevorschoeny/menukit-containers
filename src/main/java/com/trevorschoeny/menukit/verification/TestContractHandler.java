 ...
 * </ul>
 *
 * <p>This class and its siblings in {@code verification/} are Phase 5
 * contract-verification scaffolding — one-shot infrastructure that
 * produces evidence for the Phase 5 report. Removed in a follow-up commit
